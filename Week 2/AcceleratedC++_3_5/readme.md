...
Accelerated C++ problem 3-5 - Program to compute grades.
...
Select "AcceleratedC++_3_5-eclipse" directory created previously as root directory -> Finish
...
To build the project, in Eclipse, unfold AcceleratedC++_3_5-eclipse project in Project Explorer,
unfold Build Targets, double click on "all" to build all projects.

## Run

1. In Eclipse, right click on the AcceleratedC++_3_5-eclipse in Project Explorer,
...
2. In Eclipse, right click on the AcceleratedC++_3_5-eclipse in Project Explorer, select Debug As -> 
